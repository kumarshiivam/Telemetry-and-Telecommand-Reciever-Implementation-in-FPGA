...
HD_PWD='C:/Users/kumar/reciever_side_project_4/reciever_side_project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ground_segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ground_segment.tcl
