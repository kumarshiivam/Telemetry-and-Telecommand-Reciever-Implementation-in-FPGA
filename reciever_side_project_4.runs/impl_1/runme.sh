...
HD_PWD='C:/Users/kumar/reciever_side_project_4/reciever_side_project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ground_segment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ground_segment.tcl -notrace
